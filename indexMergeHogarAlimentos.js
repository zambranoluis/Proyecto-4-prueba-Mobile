...
function botonCambiarProductosDerecha(){
    indiceDisplay1++;
    indiceDisplay2++;
    if(indiceDisplay1 == categorias[indiceCategoria].productos.length-1 && indiceDisplay2 == categorias[indiceCategoria].productos.length){
        indiceDisplay1 = 0;
        indiceDisplay2 = 1;
    };
    principal();
...
function botonCambiarProductosIzquierda(){
    if(indiceDisplay1 == -1 && indiceDisplay2 == 0){
        indiceDisplay1 = categorias[indiceCategoria].productos.length-1;
        indiceDisplay2 = categorias[indiceCategoria].productos.length;
    };
    indiceDisplay1--;
    indiceDisplay2--;
    principal();
        ...
        document.getElementById("categoria").innerHTML = `
            <div id="categoria">
                <div id="fondo" class="flex justify-center items-center w-full h-[360px] bg-[url('${categorias[indiceCategoria].fondo}')] gap-[5px]">
                    <span id="botonCambiarCategoriaIzquierda" onclick="cambiarCategoriaIzquierda()" class="material-symbols-outlined select-none h-[20%] flex justify-center items-center  bg-[black]/70 rounded text-white text-[4.5rem]">chevron_left</span>
                    ...
                    <span id="botonCambiarCategoriaDerecha" onclick="cambiarCategoriaDerecha()" class="material-symbols-outlined select-none h-[20%] flex justify-center items-center  bg-[black]/70 rounded text-white text-[4.5rem]">chevron_right</span>
                </div>
                <div class="flex relative">
                    <div class="flex absolute z-10 justify-between items-center w-full px-[0.2%] ">
                        <span id="botonCambiarProductosIzquierda" onclick="botonCambiarProductosIzquierda()" class="material-symbols-outlined border h-[280px] flex items-center select-none text-white">arrow_back</span>
                        <span id="botonCambiarProductosDerecha" onclick="botonCambiarProductosDerecha()" class="material-symbols-outlined border h-[280px] flex items-center select-none text-white">arrow_forward</span>
                    </div>
...
// let boton = document.getElementById("botonCambiarCategoriaDerecha");
// boton.addEventListener('click', cambiarCategoriaDerecha);
